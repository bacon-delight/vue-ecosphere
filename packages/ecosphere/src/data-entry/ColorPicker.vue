<template>
	<div
		class="input"
		:class="[{ 'input--outline': outline, 'input--disabled': disabled }]"
	>
		<input
			v-model="value"
			class="input__field"
		...
		<div
			class="input__texts"
			:class="[{ 'input__overlay-texts': overlay }]"
		>
			<div
				class="input__label"
				:style="{ color: overlay ? overlayColor : 'inherit' }"
			>
				{{ label }}
			</div>
			<div
				class="input__color"
				:style="{ color: overlay ? overlayColor : '#a1a1a1' }"
			>
