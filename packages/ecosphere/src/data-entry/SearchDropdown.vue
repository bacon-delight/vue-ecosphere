<template>
	<div class="dropdown" :class="[{ 'dropdown--disabled': disabled }]">
		<div class="dropdown__label" :class="[`dropdown__label--${state}`]">
			{{ label }}
		</div>
		<div :id="dropdownID" class="dropdown__wrapper">
			<input
				...
				:class="[
					`dropdown__field--${state}`,
					{ 'dropdown__field--outline': outline },
					{
						'dropdown__field--selected':
							value !== null && !showOptions,
					},
				]"
				:placeholder="
					value !== null && !showOptions
				...
				>
					...
					>
						...
						<SVGIcon
							...
							:class="[
								`dropdown-option__icon--${hue}`,
								{
									'dropdown-option__icon--hidden': !(
										option.index === value
									),
								},
							]"
					...
					<div v-if="!filteredOptions.length" class="dropdown__empty">
						No Results
					</div>
				</div>
			</Transition>
		...
		<div class="dropdown__texts">
			<div
				...
				class="dropdown__alert-message"
				:class="[`dropdown__alert-message--${state}`]"
			>
				{{ alertMessage }}
			</div>
			<div v-else class="dropdown__assistive-text">
				{{ assistiveText }}
			</div>
		</div>
	</div>
