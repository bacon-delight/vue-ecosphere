<template>
	<div class="wrapper">
		<div class="wrapper__title">
			{{ $t("pages.miscellaneous.avatar.title") }}
		</div>
		<div class="wrapper__body">
			<div class="section">
				<div class="section__flex">
					<AvatarComponent
						...
						:image="
							attributeAlterations.includes('image')
			...
			<div class="section">
				<div class="section__subtitle">
					Playground (Name: Feng Mian)
				</div>
				<div class="section__description">
					Customise the options below to see changes on the avatar
				</div>
			...
			<MarkdownParser
				:content="$t('pages.miscellaneous.avatar.content')"
			></MarkdownParser>
		</div>
	</div>
</template>
