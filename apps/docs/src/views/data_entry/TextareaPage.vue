<template>
	<div class="wrapper">
		<div class="wrapper__title">
			{{ $t("pages.data_entry.textarea.title") }}
		</div>
		<div class="wrapper__body">
			<div class="section">
				...
				<TextareaField
					...
					:max-length="
						inputAttributeAlterations.includes('maxLength')
							? 15
							: null
					"
					:show-length="
						inputAttributeAlterations.includes('showLength')
					"
					:alert-message="
			...
			<div class="section">
				...
				<div class="section__description">
					Customise the options below to see changes on the input
					field
				</div>
			...
			<MarkdownParser
				:content="$t('pages.data_entry.textarea.content')"
			></MarkdownParser>
		</div>
	</div>
</template>
...
import TextareaField from "@ecosphere/data-entry/TextareaField.vue";
