...
import NavigationBar from "@ecosphere/navigation/NavigationBar.vue";
import SidebarNavigation from "@ecosphere/navigation/SidebarNavigation.vue";
import MenuNavigation from "@ecosphere/navigation/MenuNavigation.vue";
import FooterComponent from "@/components/FooterComponent.vue";
import navigation_options from "@/assets/utilities/navigation_options";
import type { menu_item } from "@ecosphere/utilities/types.interface";
